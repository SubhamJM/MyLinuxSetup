vim.wo.number = true -- activates the line number in vim
vim.o.relativenumber = true -- makes the line number relative
vim.o.clipboard = "unnamedplus" -- syncs the system clipboard with vim
